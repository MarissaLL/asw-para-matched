...
# The 'out' file here was generated by running csplit --prefix=out fastqc_data.txt "/>>END_MODULE/" "{*}" in the unzipped directory
# Each 'out' file contains a different part of the fastqc report. 4 has the GC content info. 
...
# Parameters for the expected distribution. Mean is mean overall GC content across all samples
